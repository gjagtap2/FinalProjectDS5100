...
class Die():
    ...
    def change_weight(self, face, new_weight):
        ...
        '''
        PURPOSE: a method to change the weight of a single side

        INPUTS
        face:        the face value to be changed                         [int] or [string]
        new_weight:  the new weight to be assigned to that face value     [float] or [int]
    ...
    def rollDie(self, nrolls=1):
        ...
        INPUTS
        nrolls:  how many times the die is to be rolled [int]
    ...
    def showCurrent(self):
        ...
        OUTPUTS
        dataframe created in the initialzer with the updated set of weights (if changed)
        '''
        return self._df
...
class Game():
    ...
    '''
    PURPOSE: play a game by rolling one or more dice of the same kind a given number of times
    * the class keeps the result of its most recent play
    '''
    ...
    def __init__(self,dieObjects):
        ...
        INPUTS
        dieObjects: list of already instantiated one or more similarly defined dice objects
    ...
    def play(self, num_rolls):
        ...
        INPUTS
        num_rolls:  number of times the dice should be rolled [int]
...
class Analyzer():
    ...
    * the properties results are available as attributes of an Analyzer object
    ...
    def jackpot(self):
        ...
        OUTPUTS:
        an integer for the number of times to the user
        '''
