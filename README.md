...
* Title: **MonteCarloSimulator**
* Author: **Gargee Jagtap**
...
This package implements a simple Monte Carlo simulator using a set of related classes. Professor Rafael Alvarado at the University of Virginia states:
...
On your terminal navigate to the folder where the repository is:
